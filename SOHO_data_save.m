function [data]= SOHO_data_save(expt_param, basedir)
    ...
    data.datafile = fullfile(savedir, [SubjDate, '_', sprintf('%.3d', expt_param.Run_Num), '_', expt_param.Run_name, '_SOHO', '.mat']);
