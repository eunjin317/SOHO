...
switch type
    ...
    case 'overall_resting_valence'
        temp_rating_types_pls = {
            'overall_resting_valence', '방금 세션동안 했던 생각이 긍정적 혹은 부정적이었나요?';...
            };
    ...
    case 'overall_resting_self'
        temp_rating_types_pls = {
            'overall_resting_self', '방금 세션동안 했던 생각이 얼마나 나 자신과 관련된 것이었나요?';...
            };
    ...
    case 'overall_resting_time'
        temp_rating_types_pls = {
            'overall_resting_time', '방금 세션동안 주로 했던 생각이 과거 혹은 미래에 대한 것이었나요?';...
            };
    ...
    case 'overall_task_unrelated_thought_pain'
        temp_rating_types_pls = {
            'overall_task_unrelated_thought_pain', '방금 세션동안 주로 했던 생각이 통증과제와 얼마나 관련이 된 것이었나요?';...
            };
    ...
    case 'overall_task_unrelated_thought_movie'
        temp_rating_types_pls = {
            'overall_task_unrelated_thought_movie', '방금 세션동안 주로 했던 생각이 영상과제와 얼마나 관련이 된 것이었나요?';...
            };
    ...
    case 'overall_stim_dependent_thought'
        temp_rating_types_pls = {
            'overall_stim_dependent_thought', '방금 세션동안 주로 했던 생각이 주변 자극과(ex.스캐너 소리, 화면 밝기 등)\n 얼마나 관련이 된 것이었나요?';...
            };
        ...
        temp_rating_types_pls = {
            'overall_thought_ratio', '방금 3개의 세션동안 했던 생각의 종류를 트랙볼 바를 이용하여 표시해주세요';...
            };
