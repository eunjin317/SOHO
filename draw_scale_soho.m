...
switch scale
    ...
    case 'resting_structural'  % one-directional
        ...
        Screen('DrawLine', theWindow, white, lb, H*(1/2), rb, H*(1/2), 4); % penWidth: 0.125~7.000
        Screen('DrawLine', theWindow, white, lb, H*(1/2)-scale_H/3, lb, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double('전혀'), lb-scale_H/4, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        
        Screen('DrawLine', theWindow, white, lb+(rb-lb)*0.061, H*(1/2)-scale_H/5, lb+(rb-lb)*0.061, H*(1/2)+scale_H/5, 6);
        DrawFormattedText(theWindow, double('거의\n없는'), lb+(rb-lb)*0.061-scale_H/5, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        
        Screen('DrawLine', theWindow, white, lb+(rb-lb)*0.172, H*(1/2)-scale_H/5, lb+(rb-lb)*0.172, H*(1/2)+scale_H/5, 6);
        DrawFormattedText(theWindow, double('보통'), lb+(rb-lb)*0.172-scale_H/5, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        
        Screen('DrawLine', theWindow, white, lb+(rb-lb)*0.354, H*(1/2)-scale_H/5, lb+(rb-lb)*0.354, H*(1/2)+scale_H/5, 6);
        DrawFormattedText(theWindow, double('강한'), lb+(rb-lb)*0.354-scale_H/5, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        
        Screen('DrawLine', theWindow, white, lb+(rb-lb)*0.533, H*(1/2)-scale_H/5, lb+(rb-lb)*0.533, H*(1/2)+scale_H/5, 6);
        DrawFormattedText(theWindow, double('매우 강한'), lb+(rb-lb)*0.533-scale_H/3, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
%         
        Screen('DrawLine', theWindow, white, rb, H*(1/2)-scale_H/3, rb, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double('최대'), rb-scale_H/5-3, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
    ...
    case 'overall_resting_valence'
        Screen('DrawLine', theWindow, white, lb, H*(1/2), rb, H*(1/2), 4); % penWidth: 0.125~7.000
        Screen('DrawLine', theWindow, white, W/2, H*(1/2)-scale_H/3, W/2, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double('부정'), lb-scale_H/5-3, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        Screen('DrawLine', theWindow, white, lb, H*(1/2)-scale_H/3, lb, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double(' 중립'), W/2-scale_W/5, H*(1/2)+scale_H/1.2, white);
        Screen('DrawLine', theWindow, white, W/2, H*(1/2)-scale_H/3, W/2, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double('긍정'), rb-scale_H/5-3, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        Screen('DrawLine', theWindow, white, rb, H*(1/2)-scale_H/3, rb, H*(1/2)+scale_H/3, 6);
    ...
    case 'overall_resting_self'
        ...
        DrawFormattedText(theWindow, double(' 보통'), W/2-scale_W/5, H*(1/2)+scale_H/1.2, white);
        Screen('DrawLine', theWindow, white, W/2, H*(1/2)-scale_H/3, W/2, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double(' 관련있음'), rb-scale_H/1.5, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        Screen('DrawLine', theWindow, white, rb, H*(1/2)-scale_H/3, rb, H*(1/2)+scale_H/3, 6);
        
    case 'overall_resting_time'
        Screen('DrawLine', theWindow, white, lb, H*(1/2), rb, H*(1/2), 4); % penWidth: 0.125~7.000
        Screen('DrawLine', theWindow, white, W/2, H*(1/2)-scale_H/3, W/2, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double('과거'), lb-scale_H/5-4, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        Screen('DrawLine', theWindow, white, lb, H*(1/2)-scale_H/3, lb, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double(' 현재'), W/2-scale_W/5, H*(1/2)+scale_H/1.2, white);
        Screen('DrawLine', theWindow, white, W/2, H*(1/2)-scale_H/3, W/2, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double('미래'), rb-scale_H/5-4, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        Screen('DrawLine', theWindow, white, rb, H*(1/2)-scale_H/3, rb, H*(1/2)+scale_H/3, 6);
        
    case 'overall_task_unrelated_thought_pain'
        Screen('DrawLine', theWindow, white, lb, H*(1/2), rb, H*(1/2), 4); % penWidth: 0.125~7.000
        Screen('DrawLine', theWindow, white, W/2, H*(1/2)-scale_H/3, W/2, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double('과제 관련 생각을\n 전혀 하지 않음'), lb-scale_H-16, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        Screen('DrawLine', theWindow, white, lb, H*(1/2)-scale_H/3, lb, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double('과제 관련 생각만 함'), rb-scale_H, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        Screen('DrawLine', theWindow, white, rb, H*(1/2)-scale_H/3, rb, H*(1/2)+scale_H/3, 6);
    ...
    case 'overall_stim_dependent_thought'
        Screen('DrawLine', theWindow, white, lb, H*(1/2), rb, H*(1/2), 4); % penWidth: 0.125~7.000
        Screen('DrawLine', theWindow, white, W/2, H*(1/2)-scale_H/3, W/2, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double('주변 자극 관련 생각을\n전혀 하지 않음'), lb-scale_H-16, H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        Screen('DrawLine', theWindow, white, lb, H*(1/2)-scale_H/3, lb, H*(1/2)+scale_H/3, 6);
        DrawFormattedText(theWindow, double('주변 자극\n관련 생각만 함'), rb-scale_H*(1/2), H*(1/2)+scale_H/1.2, white,[],[],[],1.2);
        Screen('DrawLine', theWindow, white, rb, H*(1/2)-scale_H/3, rb, H*(1/2)+scale_H/3, 6);
        
    case 'overall_thought_ratio'
        DrawFormattedText(theWindow, double('주황색: 통증/영상과제 관련 생각 비율'), 'center', H*(1/2)+scale_H*1.2, orange,[],[],[],0.5);
        DrawFormattedText(theWindow, double('하늘색: 주변환경 관련 생각 비율\n\n(ex.스캐너 소리, 화면 밝기 등)'), 'center', H*(1/2)+scale_H*1.5*1.2, blue,[],[],[],0.5);
        DrawFormattedText(theWindow, double('흰색: 통증/영상과제나 주변환경과\n\n상관없는 생각 비율'), 'center', H*(1/2)+scale_H*2.2*1.2, white,[],[],[],0.5);
